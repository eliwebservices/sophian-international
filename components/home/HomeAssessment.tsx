...
export default function HomeAssessment() {
  ...
  return (
    <section id="assessment" className="bg-warm py-28 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            ...
            <p className="font-display italic text-xl text-navy mb-5">
              Get a Custom Audit to Grow Your People and Culture
            </p>
            <p className="font-body text-sm leading-relaxed text-muted mb-8">
              Did you know your people and culture has three pillars — and each must be
              strong for your business to grow? Discover where you're strong, where
              you're exposed, and which lever will most improve performance.
            </p>
            ...
            <div className="flex border border-gold/25 mb-10">
              {[
                ...
                >
                  ...
                  <span className="font-body text-[9px] tracking-[0.2em] uppercase text-muted">{p.sub}</span>
                </div>
              ))}
            </div>
