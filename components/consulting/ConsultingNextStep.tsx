    ...
    return (
      <section id="contact" className="bg-navy py-28 px-6">
        <div className="max-w-3xl mx-auto text-center">
            ...
            {callSteps.map((step, i) => (
              ...
              >
                <div className="text-center flex-shrink-0 w-16">
                  ...
                  <p className="font-body text-[9px] tracking-[0.15em] uppercase text-white/35 mt-1">{step.label}</p>
                </div>
                <div className="pt-1">
          ...
          <p className="font-display italic text-lg text-white/55 mb-3">
            No pitch. No pressure. No follow-up email sequence.
          </p>
          <p className="font-body text-sm text-white/35 mb-12">
            Complimentary for qualified ownership and executive teams. Limited to 8 per month.
          </p>
  
          <a
            href="mailto:Info@sophianinternational.com"
            className="font-body text-[9px] tracking-[0.28em] uppercase bg-gold text-navy px-10 py-4 hover:bg-gold2 transition-colors duration-300 no-underline inline-flex items-center gap-3 mb-6"
          >
            Contact Us →
          </a>
          <p className="font-body text-sm text-gold/70 mt-4">
