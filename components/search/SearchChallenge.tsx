      ...
      <section className="bg-navy py-28 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="font-body text-sm leading-relaxed text-white/60 max-w-3xl mx-auto">
          ...
          <div className="border border-gold/20 p-10 md:p-14 text-center mb-14">
            <p className="font-display italic text-xl md:text-2xl text-white/90 leading-relaxed">
