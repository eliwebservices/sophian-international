        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-px bg-gold/10">
            ...
            <div className="bg-white/[0.04] p-14">
              ...
              <h2 className="font-display text-3xl font-light text-navy leading-[1.12] mb-6">
              ...
              <ul className="flex flex-col gap-3 list-none p-0 m-0">
                {gains.map((g) => (
                  <li key={g} className="flex items-center gap-3 font-body text-sm text-muted leading-relaxed">
            ...
            <div className="bg-white/[0.04] p-14">
              ...
              <ul className="flex flex-col gap-3 mb-10 list-none p-0 m-0">
                {benefits.map((b) => (
                  <li key={b} className="flex items-center gap-3 font-body text-sm text-muted leading-relaxed">
                    <span className="text-gold flex-shrink-0 mt-0.5">—</span>
                    <span>{b}</span>
                  </li>
                ))}
