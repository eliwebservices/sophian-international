...
export default function ResourcesRequest() {
  return (
    <section id="request" className="bg-cream py-28 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light text-navy leading-[1.12] mb-6">
            ...
            <span className="italic">clarity session</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-px bg-gold/15">
          ...
          <div className="bg-white p-12 flex flex-col">
            ...
            <a
              ...
              className="font-body text-sm text-[#1a1a1a] hover:text-gold transition-colors no-underline break-all mb-4"
            >
              hello@sophianinternational.com
            </a>
            <p className="font-display italic text-sm text-muted mt-auto">
          ...
          <div className="bg-navy p-12 flex flex-col">
            ...
            <div className="w-8 h-px bg-gold mb-5" />
            <p className="font-body text-sm text-white mb-4">WeChat ID: XXXXXXXX</p>
            <p className="font-display italic text-sm text-white/50 mt-auto leading-relaxed">
              Please add a note:{" "}
          ...
          <div className="bg-white p-12 flex flex-col">
            ...
            <Link
              ...
              className="mt-auto font-body text-[9px] tracking-[0.28em] uppercase bg-navy text-white px-8 py-4 hover:bg-navy2 transition-colors duration-300 no-underline inline-flex items-center gap-3 self-start"
            >
