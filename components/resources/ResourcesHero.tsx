          ...
          <div className="grid lg:grid-cols-12 gap-12 items-end">
            ...
            <div className="lg:col-span-7">
              ...
              <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-light leading-[1.08] text-white mb-10">
                Feeling Stuck in Your<br />
                <span className="italic">Hospitality Career?</span>
              </h1>
  
              <div className="w-12 h-px bg-gold mb-10" />
  
              <p className="font-body text-sm md:text-base text-white/75 max-w-xl leading-relaxed mb-12">
                Share your situation and receive one free clarity check — career direction, resume
                structure, and answers to your most important one or two questions.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                ...
                <a
                  href="#how"
                  className="font-body text-[9px] tracking-[0.28em] uppercase border border-white/40 text-white px-10 py-4 hover:border-gold hover:text-gold transition-all duration-300 no-underline inline-flex items-center gap-3"
                >
                  Learn How It Works
                </a>
              </div>
  
              <p className="font-display italic text-base text-white/45">
                For hospitality professionals seeking direction, confidence, and clarity.
              </p>
            </div>
