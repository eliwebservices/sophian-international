    ...
    return (
      <section className="bg-navy py-28 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 divide-x divide-gold/20 border border-gold/20 mb-16">
            {primary.map((s) => (
              <div key={s.label} className="py-14 px-10 text-center">
                <p className="font-display text-6xl md:text-7xl font-light text-white leading-none mb-5">
                  {s.value}
                </p>
                <div className="w-6 h-px bg-gold mx-auto mb-5" />
                <p className="font-body text-[9px] tracking-[0.2em] uppercase text-white/45 leading-relaxed">
                  {s.label}
                </p>
              </div>
            ))}
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 divide-x divide-gold/15 border border-gold/15 mb-16">
            {secondary.map((s) => (
              <div key={s.label} className="py-10 px-6 text-center">
                ...
                <p className="font-body text-[9px] tracking-[0.15em] uppercase text-white/40 leading-snug">
                  {s.label}
                </p>
              </div>
            ))}
          ...
          <p className="font-display italic text-base text-white/40 text-center mb-20">
            Experience across brands such as Accor, IHG, Hilton, Marriott, Rosewood, Aman, and
            Starwood Hotels
          </p>
  
          {/* Testimonial */}
          <div className="relative max-w-3xl mx-auto bg-white/[0.04] border border-gold/20 p-12 md:p-16 text-center text-white">
            ...
            <blockquote className="font-display italic text-xl md:text-2xl font-light text-white/90 leading-relaxed mb-10">
